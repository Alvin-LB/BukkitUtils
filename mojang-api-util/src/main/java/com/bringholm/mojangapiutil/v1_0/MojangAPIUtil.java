package com.bringholm.mojangapiutil.v1_0;
...
public class MojangAPIUtil {
    ...
    public static void getAPIStatus(ResultCallBack<Map<String, APIStatus>> callBack) {
        getAPIStatusAsync((successful, result, exception) -> new BukkitRunnable() {
            @Override
            public void run() {
    ...
    public static void getAPIStatusAsync(ResultCallBack<Map<String, APIStatus>> callBack) {
        if (plugin == null) {
            return;
        }
     ...
     */
    public static void getUUIDAtTime(String username, long timeStamp, ResultCallBack<UUIDAtTime> callBack) {
        getUUIDAtTimeAsync(username, timeStamp, (successful, result, exception) -> new BukkitRunnable() {
            @Override
            public void run() {
                callBack.callBack(successful, result, exception);
            }
     ...
     * @param callBack  the callback of the request
     */
    public static void getUUIDAtTimeAsync(String username, long timeStamp, ResultCallBack<UUIDAtTime> callBack) {
        if (plugin == null) {
            return;
        }
    ...
    public static void getNameHistory(UUID uuid, ResultCallBack<Map<String, Long>> callBack) {
        getNameHistoryAsync(uuid, (successful, result, exception) -> new BukkitRunnable() {
            @Override
            public void run() {
                callBack.callBack(successful, result, exception);
            }
     ...
     */
    @SuppressWarnings("unchecked")
    public static void getNameHistoryAsync(UUID uuid, ResultCallBack<Map<String, Long>> callBack) {
        if (plugin == null) {
            return;
        }
    ...
    public static void getUUID(List<String> usernames, ResultCallBack<Map<String, Profile>> callBack) {
        getUUIDAsync(usernames, (successful, result, exception) -> new BukkitRunnable() {
            @Override
            public void run() {
                callBack.callBack(successful, result, exception);
            }
    ...
    public static void getUUIDAsync(ResultCallBack<Map<String, Profile>> callBack, String... usernames) {
        getUUIDAsync(Arrays.asList(usernames), callBack);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static void getUUIDAsync(List<String> usernames, ResultCallBack<Map<String, Profile>> callBack) {
        if (plugin == null) {
            return;
        }
